...
namespace OutbreakZCore.Client.Config
{
    public static class ClientConfig
    {
        ...
        public const float ZombieDistanceToTargetSeeReason = 40.0f;
        public const float ZombieDistanceToTargetCloselyReason = 20.0f;
        public const float ZombieSeeAngle = 60.0f;
        ...
        public const int ZombieSpawnDelay = 2500;
        ...
        public static readonly ZombieSettings[] ZombiePresets = {
            // male
